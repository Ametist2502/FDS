...
class Menu:
    ...
    def update(self):
        ...
        if ui.button(self.surface, 320+BUTTONS_SIZES[1]*1.5, "TEST", click_sound=self.click_sound):
            return "test"

        if ui.button(self.surface, 320+BUTTONS_SIZES[1]*3.0, "Quit", click_sound=self.click_sound):
            pygame.quit()
            sys.exit()
